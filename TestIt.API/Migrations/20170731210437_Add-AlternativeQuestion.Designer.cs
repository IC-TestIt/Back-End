...
namespace TestIt.API.Migrations
{
    ...
    [Migration("20170731210437_Add-AlternativeQuestion")]
    partial class AddAlternativeQuestion
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("TestIt.Model.Entities.AlternativeQuestion", b =>
                {
                    b.HasOne("TestIt.Model.Entities.Alternative", "CorrectAlternative")
                        .WithOne("SecondAlternativeQuestion")
                        .HasForeignKey("TestIt.Model.Entities.AlternativeQuestion", "CorrectAlternativeId");
